...
public class JSidetectorAssemblyTest extends JUnitSuite {
    ...
    public static void setup() {
        ...
        testKit.spawnStandalone(com.typesafe.config.ConfigFactory.load("JSidetectorAssemblyStandalone.conf"));
    }

    @Test
    public void testAssemblyShouldBeLocatableUsingLocationService() throws ExecutionException, InterruptedException {
        Connection.AkkaConnection connection = new Connection.AkkaConnection(new ComponentId("JSidetectorAssembly", JComponentType.Assembly));
